...
frequency = [16 17 18 19 21 22 23 25 26 28 29 31 33 35 37 39 41 44 46 49 52 55 58 62 65 69 73 78 82 87 93 98 104 110];

%Latencies: Purcell Model
latency = [7.3 0 0 0 29 0];

%Scale amplitude
stimamp = frequency./frequency;

%Amplitude values
amp = [0.35 0 0 0 0.85 0];

%Drop out frequencies
dropoutfreq = [880 0 0 0 95 0];  %drop out frequenices for each generator. 
